...
export function ObjectiveScreen({ navigation, route }: any) {
    ...
    const [selectedObjective, setSelectedObjective] = useState<string | null>(data.goal || null);

    const handleSelect = (option: ObjectiveOption) => {
        setSelectedObjective(option.id);
        updateData({ goal: option.storeValue });
    };
        ...
        <View style={styles.container}>
            ...
            <View style={styles.content}>
                ...
                <View style={styles.nextButtonContainer}>
                    <NextButton onPress={handleNext} disabled={!selectedObjective} />
                </View>
            </View>
        </View>
    );
