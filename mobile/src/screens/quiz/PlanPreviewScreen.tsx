...
import { colors, createThemeStyles, useThemeSubscription, getThemeStatusBarStyle } from '../../theme';
...
const WalkingIcon = ({ active }: { active: boolean }) => (
    <Svg width={20} height={20} viewBox="0 0 20 21" fill="none">
        <Path
            ...
            fill={active ? '#00D4FF' : semanticColors.textSecondary}
        />
    </Svg>
);
    ...
    <View style={[styles.optionIconContainer]}>
        <Svg width={18} height={22} viewBox="0 0 18 22" fill="none">
            <Path
                ...
                fill={selected ? '#00D4FF' : semanticColors.textPrimary}
            />
        </Svg>
    </View>
);
