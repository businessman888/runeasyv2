...
export function LevelScreen({ navigation, route }: any) {
    ...
    const [selectedLevel, setSelectedLevel] = useState<string | null>(
        data.experience_level ? levels.find(l => l.storeValue === data.experience_level)?.id || null : null
    );

    const handleSelect = (option: LevelOption) => {
        setSelectedLevel(option.id);
        updateData({ experience_level: option.storeValue });
    };
        ...
        <View style={styles.container}>
            ...
            <View style={styles.content}>
                ...
                <View style={styles.nextButtonContainer}>
                    <NextButton onPress={handleNext} disabled={!selectedLevel} />
                </View>
            </View>
        </View>
    );
